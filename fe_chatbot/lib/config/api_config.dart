...
class ApiConfig {
  ...
  static const String ngrokSubdomain = '2698-2404-c0-2420-00-1847-e54b'; // Replace with your ngrok subdomain
  ...
  static String get imageEndpoint => _buildUrl('/api/upload/image');
