...
class ApiConfig {
  ...
  static const String ngrokSubdomain = 'e0bc-2404-c0-2450-00-340d-9c11'; // Replace with your ngrok subdomain
  ...
  static String get imageEndpoint => _buildUrl('/api/analyze/image');
