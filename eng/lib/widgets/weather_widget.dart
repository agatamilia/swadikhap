...
class _WeatherWidgetState extends State<WeatherWidget> {
  ...
  String _locationName = 'Finding current location...';
  ...
  Future<void> _fetchWeather() async {
    try {
      ...
      setState(() {
        _locationName = placeName ?? 'Unknown location';
      ...
      setState(() {
        ...
        _weatherData = WeatherData(
          ...
          description: 'Clear',
          location: 'Jakarta',
          advice: 'Good weather for harvesting',
        );
      });
    }
  }
  ...
  Widget _buildWeatherStatusIndicator() {
    switch (_state) {
      ...
      case WeatherState.error:
        return Icon(Icons.error_outline, color: Colors.red[400], size: 40);
