...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _loadSessionMessages() async {
    ...
    if (sessionProvider.currentSession != null) {
      ...
      _scrollToBottom(); // move here so scroll works after messages are loaded
    }
  }
  ...
  Future<void> _checkPermissions() async {
    ...
    for (int i = 0; i < permissions.length; i++) {
      if (!permissions[i] && mounted) {
        final label = ['Location', 'Microphone', 'Storage'][i];
  ...
  Future<void> _handleSubmitted(BuildContext context, String text) async {
    ...
    if (sessionProvider.currentSession != null) {
      await chatProvider.sendMessage(
        ...
        sessionProvider,
        scrollToBottomCallback: _scrollToBottom, // scroll only after user message
      );
    }
  ...
  Widget _buildVoiceOutputToggle(ChatProvider chatProvider) {
    return Tooltip(
      message: "Enable/disable voice for assistant's answers",
      child: Row(
        children: [
          Icon(
      ...
      builder: (context) => Column(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              chatProvider.pickImageFromGallery(context);
            },
          ),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              "Ask about farming techniques, weather, or plant pests",
  ...
  Widget _buildChatList(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        // Check if this is the index for the loading assistant
                ...
                confirmDismiss: (direction) async {
                  return await showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: const Text('Delete Message', style: TextStyle(fontSize: 22)),
                        content: const Text('Are you sure you want to delete this message?', style: TextStyle(fontSize: 18)),
                        actions: [
                          TextButton(
  ...
  Widget _buildBoldAndLinkifiedText(String text) {
    ...
    return Linkify(
      ...
      text: text.replaceAll('*', ''), // so Linkify doesn't get confused by the * symbol
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: hasImage
                          ? "Type a question for this image..."
