...
class ImageService {
  ...
  _getImageContentType(String filePath) {
    ...
    switch (ext) {
      case '.jpg':
      case '.jpeg':
        return ImageMediaType('image', 'jpeg');
      case '.png':
        return ImageMediaType('image', 'png');
      case '.gif':
        return ImageMediaType('image', 'gif');
      default:
        return ImageMediaType('image', 'jpeg'); // Default
    }
  }
}

// Fix the MediaType class name conflict
class ImageMediaType {
  final String type;
  final String subtype;
  
  ImageMediaType(this.type, this.subtype);
