...
class ChatProvider with ChangeNotifier {
  ...
  Future<void> switchToSession(String sessionId, SessionProvider sessionProvider) async {
    try {
  ...
  Future<void> createNewChat(SessionProvider sessionProvider) async {
    try {
      final newSession = await sessionProvider.createNewSession('New Chat');
  ...
  Future<void> clearChat(String sessionId) async {
    try {
      _messages.clear();
      notifyListeners();
      await _apiService.clearMessages(sessionId);
    } catch (e) {
